...
enum ethtool_rx_data_stagger {
	ETHTOOL_RX_DATA_STAGGER_UNKNOWN,
...
enum {
	...
	ETHTOOL_A_RINGS_STAGGER_STRIDE,
	ETHTOOL_A_RINGS_STAGGER_STRIDE_MIN,
	ETHTOOL_A_RINGS_STAGGER_STRIDE_MAX,
