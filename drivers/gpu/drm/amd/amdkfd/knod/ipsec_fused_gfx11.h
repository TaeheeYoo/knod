...
static inline int kfd_ipsec_gen_fused_shader_gfx11(void *vbuf)
{
	...
	_E(emit_gfx11_global_load_dwordx2, I11(buf, n), P_V(VR_DATA2),
	...
	_E(emit_gfx11_v_mov_b32_e32, I11(buf, n), P_V(VR_SAVE_STATS_LO),
	   P_V(VR_DATA2));
	_E(emit_gfx11_v_mov_b32_e32, I11(buf, n), P_V(VR_SAVE_STATS_HI),
	   P_V(VR_DATA3));
	...
	_E(emit_gfx11_v_mov_b32_e32, I11(buf, n), P_V(VR_DATA0), P_I(1));
	_E(emit_gfx11_v_mov_b32_e32, I11(buf, n), P_V(VR_DATA1), P_I(0));
	_E(emit_gfx11_global_atomic_add_x2, I11(buf, n),
